...
const deleteJob = async function (req, res) {
  ...
  // Model.findOneAndDelete() finds a matching document, removes it, and returns the found document (if any)
  // Model.findOneAndRemove() is the same, but becomes a MongoDB findAndModify().
  // For most mongoose use cases, this distinction is purely pedantic. You should use findOneAndDelete() unless you have a good reason not to.
